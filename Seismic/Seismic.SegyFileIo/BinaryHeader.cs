...
{
    public class BinaryHeader : IEquatable<BinaryHeader>
    {
        ...
        public BinaryHeader(short sampleRateInMicroUnits, short sampleCountPerTrace)
        {
        ...
        protected BinaryHeader(BinaryHeader hdr)
        {
            JobId = hdr.JobId;
            LineNum = hdr.LineNum;
            Reelnum = hdr.Reelnum;
        ...
        public static BinaryHeader From(byte[] bytes, bool isLittleEndian)
        {
        ...
        public static bool operator ==(BinaryHeader a, BinaryHeader b)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals((BinaryHeader)obj);
        }
        ...
        #region IDeepCloneable<BinaryHeder> members

        public BinaryHeader DeepClone() => new BinaryHeader(this);

        #endregion IDeepCloneable<BinaryHeder> members
    }
