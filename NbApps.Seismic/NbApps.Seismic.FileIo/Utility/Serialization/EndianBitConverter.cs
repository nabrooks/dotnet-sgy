...
namespace Utility.Io.Serialization
{
	...
	public abstract class EndianBitConverter
	{
		...
		public virtual int SingleToInt32Bits(float value)
		{
		...
		public virtual float Int32BitsToSingle (int value)
		{
		...
		/// <summary>
		/// Returns a set of double-precision floating point numbers converted from eight bytes 
		/// at a specified position in a byte array.
		/// </summary>
		/// <param name="values">An array of bytes.</param>
		/// <param name="startIndex">The starting position within value.</param>
		/// <returns>An array of double precision floating point numbers formed by eight bytes each beginning at startIndex.</returns>
		...
		/// <summary>
		/// Returns an array of single-precision floating point numbers converted from four bytes each
		/// at a specified position in a byte array.
		/// </summary>
		/// <param name="values">An array of bytes.</param>
		/// <param name="startIndex">The starting position within value.</param>
		/// <returns>An array of single precision floating point numbers formed by four bytes each beginning at startIndex.</returns>
